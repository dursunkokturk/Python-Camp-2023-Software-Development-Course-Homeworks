...
class TestInvalidloginwait():
  ...
  def test_invalidloginwait(self):
    ...
    loginUserNameInput = self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"username\"]")
    ...
    loginPasswordInput = self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"password\"]")
    loginPasswordInput.send_keys("1")
